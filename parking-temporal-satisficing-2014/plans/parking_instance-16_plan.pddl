...
Initial heuristic = 19.000, admissible cost estimate 4.003
b (18.000 | 2.000)b (17.000 | 2.000)b (16.000 | 2.000)b (15.000 | 2.000)b (13.000 | 3.001)b (11.000 | 3.001)b (10.000 | 4.002)b (9.000 | 4.002)b (8.000 | 4.002)b (7.000 | 4.002)b (6.000 | 4.002)b (5.000 | 4.002)b (4.000 | 4.002)b (3.000 | 4.002)b (2.000 | 4.002)b (1.000 | 4.002)(G)
...
0.000: (move-car-to-curb car_12 car_00 curb_12)  [2.000]
0.000: (move-car-to-curb car_10 car_07 curb_10)  [2.000]
0.000: (move-car-to-curb car_09 car_08 curb_09)  [2.000]
0.000: (move-car-to-curb car_03 car_02 curb_11)  [2.000]
0.000: (move-car-to-curb car_06 car_11 curb_14)  [2.000]
0.000: (move-car-to-curb car_05 car_01 curb_15)  [2.000]
2.001: (move-curb-to-curb car_08 curb_01 curb_08)  [1.000]
2.001: (move-curb-to-curb car_07 curb_03 curb_07)  [1.000]
2.001: (move-curb-to-curb car_02 curb_06 curb_16)  [1.000]
2.001: (move-curb-to-curb car_01 curb_05 curb_17)  [1.000]
2.001: (move-curb-to-curb car_11 curb_02 curb_18)  [1.000]
3.002: (move-curb-to-curb car_03 curb_11 curb_03)  [1.000]
3.002: (move-curb-to-curb car_06 curb_14 curb_06)  [1.000]
3.002: (move-curb-to-curb car_05 curb_15 curb_05)  [1.000]
3.002: (move-curb-to-curb car_02 curb_16 curb_02)  [1.000]
3.002: (move-curb-to-curb car_01 curb_17 curb_01)  [1.000]
4.003: (move-curb-to-curb car_11 curb_18 curb_11)  [1.000]

 * All goal deadlines now no later than 5.003

Resorting to best-first search
Running WA* with W = 5.000, not restarting with goal states
b (18.000 | 2.000)b (17.000 | 2.000)b (16.000 | 3.001)b (15.000 | 3.001)b (14.000 | 3.001)b (13.000 | 3.001)b (11.000 | 3.001)b (10.000 | 3.001)b (9.000 | 4.002)b (9.000 | 3.001)b (8.000 | 4.002)b (8.000 | 3.001)b (7.000 | 4.002)b (6.000 | 4.002)b (5.000 | 4.002)b (4.000 | 4.002)b (3.000 | 4.002)b (2.000 | 4.002)b (1.000 | 4.002)(G)
; LP calculated the cost

; Plan found with metric 4.002
; Theoretical reachable cost 4.003
; States evaluated so far: 3740
; States pruned based on pre-heuristic cost lower bound: 0
; Time 55.88
0.000: (move-car-to-curb car_09 car_08 curb_09)  [2.000]
0.000: (move-car-to-curb car_13 car_04 curb_13)  [2.000]
0.000: (move-car-to-curb car_12 car_00 curb_12)  [2.000]
0.000: (move-car-to-curb car_10 car_07 curb_10)  [2.000]
0.000: (move-car-to-curb car_03 car_02 curb_14)  [2.000]
0.000: (move-car-to-curb car_06 car_11 curb_16)  [2.000]
0.000: (move-car-to-curb car_05 car_01 curb_17)  [2.000]
2.001: (move-curb-to-curb car_08 curb_01 curb_08)  [1.000]
2.001: (move-curb-to-curb car_07 curb_03 curb_07)  [1.000]
2.001: (move-curb-to-curb car_02 curb_06 curb_15)  [1.000]
2.001: (move-curb-to-curb car_11 curb_02 curb_11)  [1.000]
2.001: (move-curb-to-curb car_01 curb_05 curb_18)  [1.000]
3.002: (move-curb-to-curb car_03 curb_14 curb_03)  [1.000]
3.002: (move-curb-to-curb car_06 curb_16 curb_06)  [1.000]
3.002: (move-curb-to-curb car_05 curb_17 curb_05)  [1.000]
3.002: (move-curb-to-curb car_02 curb_15 curb_02)  [1.000]
3.002: (move-curb-to-curb car_01 curb_18 curb_01)  [1.000]

 * All goal deadlines now no later than 4.002

Problem Unsolvable
;;;; Solution Found
; States evaluated: 3740
; Cost: 4.002
; Time 55.94
0.000: (move-car-to-curb car_09 car_08 curb_09)  [2.000]
0.000: (move-car-to-curb car_13 car_04 curb_13)  [2.000]
